...
function capitalizeNames (names) {
  ...
  //mora da ima loop za izminuvanje na nizata
  for (let name of names) {
    ...
    newName = newName.split(' ')  //["Stefani", "nelkovska" "mladenovska"]
...
capitalizeNames(['KriStiJaN', 'Stefani nelkovska mladenovska', 'riSte'])
